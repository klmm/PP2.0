...
//---------------------------------------------ZONE PRONO------------------------------------------------------//
	...
	echo '		    <button id="validate" type="button" class="btn btn-primary btn-block" action="/jeux/biathlon/lib/form/envoi_prono.php">Valider</button>';
    }
    else{
	if($mise_resultat == true){
	    echo '	    <button id="validate" type="button" class="btn btn-primary btn-block" action="/jeux/biathlon/admin/envoi_resultat.php">Enregistrer</button>';
	}
    }
